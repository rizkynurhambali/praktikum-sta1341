...
```{r}
set.seed(8990)
dt_alt <- arima.sim(n=200, list(order=c(1,0,1),ar=c(.2), ma=.2), mean=0.2)  |> ts()
...
Berdasarkan plot ACF, terlihat bahwa data stasioner, ditandai dengan plot ACF yang *cuts off* di lag pertama
...
Berdasarkan plot ACF, terlihat bahwa data cenderung stasioner ditandai dengan
