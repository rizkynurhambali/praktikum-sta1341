...
Akan dicoba membangkitkan proses AR paling sederhana, yaitu MA(1) dengan $\phi = 0.7$ sebanyak 200 observasi dan $c=0$. Karena diperlukan satu nilai awal untuk $e_{t-1}$, masukkan nilai pertama white noise sebagai nilai awal tersebut.
